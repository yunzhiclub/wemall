 ...
 * Dec : ucpass php demo
 */
class UcpaasModel extends Model
{
    ...
    {
        $options['accountsid']='ced3ca9b971ac1d639fbbb378e3a295e'; //填写自己的
        $options['token']='5b1e34f67dc0ed238c3be03a63122f59'; //填写自己的
        $this->appId = "df4f6d5faf794ebba0d26db82025b77f";  //填写自己的
        $this->templateId = "6557";
    ...
    {
        $jsonArr = $this->templateSMS($this->appId,$this->phone,$this->templateId,$this->text);
        $stdClass = json_decode($jsonArr);
        $code = $stdClass->resp->respCode;
        if ($code == '000000') {
