<?php if (!defined('THINK_PATH')) exit(); if(is_array($list)): foreach($list as $key=>$goods): ?><div class="row line">
        <div class="col-xs-4">
            <a class="goods-list-content" href="<?php echo ($goodsDetailUrl); ?>?goodsId=<?php echo ($goods["id"]); ?>">
                <img class="img-rounded img-responsive" href="<?php echo ($goodsDetailUrl); ?>?goodsId=<?php echo ($goods["id"]); ?>" src="<?php echo ($goods["image_path"]); ?>" /></a>
        </div>
        <div class="col-xs-8">
            ...
            <?php if(($customerType) == "1"): ?><div class="row row2">
