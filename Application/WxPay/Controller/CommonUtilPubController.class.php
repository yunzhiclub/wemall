...
class CommonUtilPubController {
    public function __construct() 
    {
        
    }
    //如果字符串为空串，返回NULL，否则返回字符串
     ...
     */
    public function formatBizQueryParaMap($paraMap, $urlencode = true)
    {
        $buff = "";
        ksort($paraMap);
...
//        curl_setopt($ch,CURLOPT_SSLCERT,add_root_path(C('WXPAY_SSLCERT_PATH')));
        $certPath = dirname(THINK_PATH) . C('WXPAY_SSLCERT_PATH');
        curl_setopt($ch,CURLOPT_SSLCERT, $certPath );
 
//默认格式为PEM，可以注释
        curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
//        curl_setopt($ch,CURLOPT_SSLKEY, add_root_path(C('WXPAY_SSLKEY_PATH')));
        $keyPath = dirname(THINK_PATH) . C('WXPAY_SSLKEY_PATH');
